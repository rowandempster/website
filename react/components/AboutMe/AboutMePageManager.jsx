...
var AboutMePageManager = React.createClass({
  ...
  goToNextPageFromButton: function(){
  ...
  render:function(){
    ...
    if(this.state.currentPage == pageArray.length-1){
      nextPageButton = <Button onClick={this.goToNextPageFromButton} disabled bsStyle="primary" style={styles.bottomButton}>
        Go To Next Page
      </Button>;
    }
    else{
      nextPageButton =
      <Button onClick={this.goToNextPageFromButton} bsStyle="primary" style={styles.bottomButton}>
        Go To Next Page
      </Button>;
    }
    ...
    if(this.state.previousPage == -1){
      returnToTopButton =
      <Button onClick={this.goToTopFromButton} disabled bsStyle="primary" style={styles.bottomButton}>
        Return To Top
      </Button>;
    }
    else{
      returnToTopButton =
      <Button onClick={this.goToTopFromButton} bsStyle="primary" style={styles.bottomButton}>
        Return To Top
      </Button>;
    }
    return (
