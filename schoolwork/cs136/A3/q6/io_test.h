...
//   for an integer function [func] with param_count int parameters
void add_int_test(const char *name, // Str
                  void *func,       // Function
                  int param_count);

// add_void_test(name, func, param_count) adds a new test [name]
//   for a void function [func] with param_count int parameters
void add_void_test(const char *name, // Str
                   void *func,       // Function
                   int param_count);
